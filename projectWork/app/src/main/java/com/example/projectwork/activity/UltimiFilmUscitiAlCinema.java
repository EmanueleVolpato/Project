...
public class UltimiFilmUscitiAlCinema extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ultimi_film_usciti_al_cinema);
        getSupportActionBar().setTitle("NOVITA'");
    }
